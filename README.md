...
![contribute_to_pr](https://github.com/BrendonLiu/azure-pipeline-gpt-pr-review/blob/main/images/contribute_to_pr.png?raw=true)
...
![allow_access_token](https://github.com/BrendonLiu/azure-pipeline-gpt-pr-review/blob/main/images/allow_access_token.png?raw=true)
...
Found and fixed a bug or improved on something? Contributions are welcome! Please target your pull request against the `main` branch or report an issue on [GitHub](https://github.com/BrendonLiu/azure-pipeline-gpt-pr-review/issues) so someone else can try and implement or fix it.

## License

[MIT](https://raw.githubusercontent.com/BrendonLiu/azure-pipeline-gpt-pr-review/main/LICENSE)
